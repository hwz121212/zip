...
{ HZIP hz; HANDLE hf; DWORD writ; ZRESULT zr; ZIPENTRY ze; TCHAR m[1024];
  ...
  { const TCHAR *c=_T("Time waits for no man\r\n");
  ...
  { const TCHAR *c=_T("Hello just a dummy file\r\n");
